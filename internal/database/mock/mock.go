...
func (m *QuerierNotification) SelectUserIDAndPasswordByEmail(ctx context.Context, email string) (sqlc.SelectUserIDAndPasswordByEmailRow, error) {
	args := m.Called(ctx, email)
	return args.Get(0).(sqlc.SelectUserIDAndPasswordByEmailRow), args.Error(1)
}
